...
class RecyclerItemClickListener(context: Context?, recyclerView: androidx.recyclerview.widget.RecyclerView, private val mListener: OnItemClickListener?) : OnItemTouchListener {
